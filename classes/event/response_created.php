 ...
 */
class response_created extends \core\event\base {
    /**
     * Method init.
     *
    ...
    public static function get_name() {
        return get_string("eventresponsecreated", "rank");
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' submitted ranking response " .
